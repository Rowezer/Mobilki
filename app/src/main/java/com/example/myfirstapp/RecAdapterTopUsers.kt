...
class RecAdapterTopUsers(private val topUsersList: List<DataClassUser>) :
    RecyclerView.Adapter<RecAdapterTopUsers.TopUsersViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TopUsersViewHolder {
        val itemView =
            LayoutInflater.from(parent.context).inflate(R.layout.top_card_view, parent, false)
